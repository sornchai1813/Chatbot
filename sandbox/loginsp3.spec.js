...
test('Sprinklr Full Process - Codegen Style with Variables', async ({ browser }) => {
  // ---------------------------------------------------------
  // 🪄 1. ส่วนตัวแปร (ดึงออกมาไว้ข้างนอกตามที่คุยกัน)
  // ---------------------------------------------------------
  const myCaseID = '69784';               // เลขเคส
  // const expectedText1 = 'Select value';   // ค่าที่ตรวจช่อง 5098
  // const expectedText2 = 'Select value';   // ค่าที่ตรวจช่อง 5099
  const expectedText1 = 'Application';   // ค่าที่ตรวจช่อง 5098
  const expectedText2 = 'Alert อัพเดทเวอร์ชันแอปพลิเคชัน';   // ค่าที่ตรวจช่อง 5099
  // ---------------------------------------------------------
